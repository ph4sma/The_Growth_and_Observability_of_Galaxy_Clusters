...
void plot_results(int graph_type)
{
    ...
    if (graph_type == 1)
    {
        ...
        fprintf(pipe, " set output '/Users/cosimacalder/Documents/J/University/Year_4/Project/Lit_Review/Figures/M_ratio.eps'\n");
        ...
        fprintf(pipe, "splot '/Users/cosimacalder/documents/J/J_PROJECT/work/work/DeltaM.txt' u 1:8:6 ls 7  notitle  w pm3d\n");
    }
    else
    {
        fprintf(pipe, " set cntrparam levels 5\n");
        fprintf(pipe, " set output '/Users/cosimacalder/Documents/J/University/Year_4/Project/Lit_Review/Figures/L_ratio.eps'\n");
        ...
        fprintf(pipe, "splot '/Users/cosimacalder/documents/J/J_PROJECT/work/work/DeltaM.txt' u 1:5:3 ls 7 notitle w pm3d\n");
